        ...
        <div class="book-detail-container">
            <div class="book-info">
                <div style="padding: 20px;position: relative;">
                    ...
                    <el-button :disabled="!loginStatic.isLogin" v-show="exame"  @click="buyBookVisible = true" type="primary" size="normal" class="book-info-buy">
                        立即购买
                    </el-button>
                    <el-dialog
            ...
            <div class="book-aside">
                <div style="padding:10px;cursor: pointer">
                    <router-link to="/bookStore"><i class="el-icon-caret-left mr10"></i> 返回书店</router-link>
                    <router-link v-show="loginStatic.isLogin" :to="toMyBook"><i class="el-icon-goods mr10"></i> 我购买的书</router-link>
                </div>
            </div>
            <div class="book-info-jianjie">
                <div class="book-info-jianjie-title tit">
                    简介
                </div>
                <div style="padding: 0 1rem">
                    <p style="word-wrap:break-word;line-height: 30px;padding: 20px 0;">{{bookDetail.description}}</p>
                    <div class="ExtInfo">
                        <div class="ExtInfo-item">
                            <b class="tit">作者</b>{{bookDetail.author}}
                        </div>
                        <div class="ExtInfo-item">
                            <b class="tit">书名</b>{{bookDetail.name}}
                        </div>
                        <div class="ExtInfo-item">
                            <b class="tit">上架时间</b>{{bookDetail.createdAt}}
                        </div>
                    </div>
                </div>
            </div>
